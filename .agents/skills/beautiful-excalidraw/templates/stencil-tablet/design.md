...
colors:
  ...
  paper: "#F4EFE0" # lighter cream than bone, for cards that should sit lighter (tables, chart frames, timeline bars)
...
# Stencil & Tablet — Excalidraw Whiteboard Design System
