...
colors:
  ...
  ink: "#000000" # ink / structure — pure black, carries the heavy display word; on a pastel block place ONLY a large black display word, never small dark labels
  ...
  # Rule: dark text on the page or on light cards. To make a colour lighter, pick a lighter solid hex, never opacity.
...
# Confetti Wedge — Excalidraw Whiteboard Design System
