...
# ── COLOR ────────────────────────────────────────────────────
colors:
  white: "#FFFFFF" # canvas — pure white, generous and empty; the empty white field around the cluster is the only restraint — preserve it
  ...
  # Vermilion is the connective ink. Dark/maroon text on light fills (white/pink/periwinkle/chartreuse); white/chartreuse text on dark (pine/maroon). Never put small text on a same-hue fill.
...
# Crayon Stack — Excalidraw Whiteboard Design System
